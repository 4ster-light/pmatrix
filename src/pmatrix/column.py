"""Column class managing a single vertical column of drops."""
...
class Column:
	...
	def __init__(self, height: int) -> None:
		...
		Args:
			height: The height of the terminal in rows.
		"""
		self.height = height
	...
	def character_at(self, row: int) -> tuple[str, float] | None:
		...
		Returns:
			A tuple of (character, intensity) if present, None otherwise.
		"""
